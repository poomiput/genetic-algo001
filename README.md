...
Genetic Algorithm (GA) เป็น**อัลกอริทึม**หนึ่ง เช่นเดียวกับ DFS, BFS หรือ Dijkstra — คือเป็น "วิธีการ/ขั้นตอนวิธี" ที่ใช้แก้ปัญหา แต่ต่างกันที่ประเภทของปัญหาที่ถนัด:

| อัลกอริทึม | ประเภท | ใช้แก้ปัญหาแบบไหน |
|---|---|---|
| DFS / BFS | Graph Traversal | สำรวจกราฟ, หาเส้นทาง, เช็คการเชื่อมต่อ |
| Dijkstra | Shortest Path | หาเส้นทางสั้นสุดจากจุดหนึ่งไปอีกจุด |
| **Genetic Algorithm** | Optimization (Metaheuristic) | หาคำตอบที่ดีที่สุดจากตัวเลือกจำนวนมหาศาล เช่น จัดเส้นทางรถส่งของหลายคัน |

หลักการทำงานของ GA ได้แรงบันดาลใจจากการคัดเลือกโดยธรรมชาติ (Natural Selection): สร้าง "ประชากร" ของคำตอบที่เป็นไปได้ แล้วค่อย ๆ ปรับปรุงคำตอบผ่านการคัดเลือก ผสมพันธุ์ และกลายพันธุ์ ซ้ำไปเรื่อย ๆ จนได้คำตอบที่ดีที่สุด (หรือใกล้เคียงที่สุด)

เหตุที่งาน Logistics นิยมใช้ GA แทนการไล่เช็คทุกความเป็นไปได้ เพราะปัญหาอย่าง TSP/VRP มีจำนวนคำตอบที่เป็นไปได้มหาศาล (ลูกค้า n ราย = n! เส้นทาง) การไล่เช็คหมดทุกแบบใช้เวลานานเกินไป GA จึงใช้วิธี "วิวัฒนาการ" คำตอบให้ดีขึ้นเรื่อย ๆ และได้คำตอบที่ดีมากภายในเวลาไม่กี่วินาที
